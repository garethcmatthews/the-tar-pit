 ...
 * About test case.
 */
class ConfiguratonFileExceptionTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        try {
            throw new Exception\ConfiguratonFileException('Testing');
        } catch (Exception\ConfiguratonFileException $e) {
            $this->assertEquals('Application Configuration Error: Testing', $e->getMessage());
        }
    }
    ...
    public function testException_renderResponseJson_data()
    {
        ...
        try {
            ...
            $this->assertEquals('application-configuration-error', $element['error']);
        }
    }
}
