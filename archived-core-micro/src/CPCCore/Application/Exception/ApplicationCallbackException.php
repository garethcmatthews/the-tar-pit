...
namespace CPCCore\Application\Exception;

/**
 * Application Callback Model Exception
 *
 * Used by the before and after router callbacks.
 *
 * @package CPCCore
 ...
 * @since   1.0.0
 */
class ApplicationCallbackException extends \Exception
{
